...
namespace Laravie\DynamoDb\Facades;

use Illuminate\Support\Facades\Facade;

/**
 * @method static \Aws\DynamoDb\DynamoDbClient client()
 * @method static \Laravie\DynamoDb\DynamoDb\QueryBuilder table($name)
 * @method static \Laravie\DynamoDb\DynamoDb\QueryBuilder newQuery()
